...
export function SecurityBell() {
    ...
    return (
        <div className="relative" ref={menuRef}>
            ...
            {isOpen && (
                <div className="absolute right-0 top-12 z-50 w-[320px] rounded-2xl bg-background/80 backdrop-blur-3xl border border-border shadow-2xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
