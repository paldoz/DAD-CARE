...
export function SecurityBell() {
    ...
    return (
        <div className="relative" ref={menuRef}>
            ...
            {isOpen && (
                <div className="absolute right-0 sm:right-0 top-12 z-50 w-[300px] sm:w-[360px] max-w-[calc(100vw-2rem)] rounded-3xl bg-background/50 dark:bg-background/40 backdrop-blur-[40px] border border-white/20 dark:border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.15)] overflow-hidden animate-in fade-in slide-in-from-top-2 duration-300">
