                                                ...
                                                <div className="flex items-center gap-3 md:gap-4 flex-1">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <div className="flex items-center gap-3">
                                                            <h4 className="font-semibold text-foreground text-base md:text-lg whitespace-nowrap">
                                                                {format(new Date(entry.date), 'MMM dd, yyyy')}
                                                            </h4>
                                                            <span className="flex items-center gap-1 text-xs md:text-sm text-muted-foreground whitespace-nowrap">
                                                                <BookOpen className="w-3 h-3" />
                                                                {entry.items.length} <span className="hidden md:inline">customers</span>
                                                            </span>
                                                        </div>
                                                        
                                                        {/* Dedicated full-width line for kinetic stats */}
                                                        <div className="w-full mt-2 overflow-hidden relative">
                                                            <div className="inline-flex items-center gap-3 w-max animate-kinetic">
                                                                ...
                                                                {(() => {
                                                                    ...
                                                                    return entryVipCount > 0 ? (
                                                                        <button
                                                                            ...
                                                                            className="inline-flex items-center justify-center px-2 py-0.5 rounded text-xs font-black uppercase tracking-wider bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-500 text-yellow-950 shadow-[0_0_12px_rgba(251,191,36,0.6)] border border-yellow-200 hover:brightness-110 active:scale-95 transition-all cursor-pointer"
                                                                        >
                                                                            👑 {entryVipCount} VIP
                                                                        </button>
                                                                    ) : null;
                                                                ...
                                                                {historyLedgerStatus[entry.date] ? (() => {
                                                                    ...
                                                                    return processed === total && total > 0 ? (
                                                                        <span className="inline-flex items-center gap-1 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 px-2 py-0.5 rounded-full text-xs font-black uppercase tracking-wide border border-emerald-500/20">
                                                                            ✓ All in Maqalka
                                                                        </span>
                                                                    ) : (
                                                                        <span className="inline-flex items-center gap-1 bg-amber-500/10 text-amber-600 dark:text-amber-400 px-2 py-0.5 rounded-full text-xs font-black uppercase tracking-wide border border-amber-500/20">
