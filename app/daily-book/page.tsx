                                            ...
                                            <div className="flex flex-col md:flex-row md:items-center justify-between p-4 cursor-pointer">
                                                <div className="flex items-center gap-3 md:gap-4 flex-1">
                                                    ...
                                                    <div className="flex-1 w-full">
                                                        ...
                                                        <div className="flex flex-col gap-2 mt-2 text-xs md:text-sm text-muted-foreground w-full">
                                                            <span className="flex items-center gap-1">
                                                                <BookOpen className="w-3 h-3" />
                                                                {entry.items.length} <span className="hidden md:inline">customers</span>
                                                            </span>
                                                            
                                                            {/* No overflow hidden, guaranteed visibility */}
                                                            <div className="w-full flex items-center py-1">
                                                                <div className="inline-flex items-center gap-3 w-max animate-kinetic px-2">
