                                                ...
                                                <div className="flex items-center gap-3 md:gap-4 flex-1">
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <div className="flex flex-wrap items-center gap-1 md:gap-3 text-xs md:text-sm text-muted-foreground mt-1">
                                                            ...
                                                            <div className="flex-1 w-full min-w-[200px] overflow-hidden relative [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)]">
                                                                <div className="inline-flex items-center gap-2 md:gap-3 w-max animate-kinetic px-4 py-1">
