                                                                ...
                                                                <div className="inline-flex items-center gap-2 md:gap-3 w-max animate-kinetic px-2">
                                                                    ...
                                                                    {historyLedgerStatus[entry.date] ? (() => {
                                                                        ...
                                                                        return processed === total && total > 0 ? (
                                                                            <span className="inline-flex items-center gap-1 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 px-2 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wide border border-emerald-500/20">
                                                                                ✓ All in Maqalka
                                                                            </span>
                                                                        ) : (
                                                                            <span className="inline-flex items-center gap-1 bg-amber-500/10 text-amber-600 dark:text-amber-400 px-2 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wide border border-amber-500/20">
